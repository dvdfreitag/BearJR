...
#define FUSES_OSC32KCAL_Msk         (_U(0x7F) << FUSES_OSC32KCAL_Pos)
...
#define NVMCTRL_FUSES_HOT_ADC_VAL_Msk (_U(0xFFF) << NVMCTRL_FUSES_HOT_ADC_VAL_Pos)
...
#define NVMCTRL_FUSES_HOT_INT1V_VAL_Msk (_U(0xFF) << NVMCTRL_FUSES_HOT_INT1V_VAL_Pos)
...
#define NVMCTRL_FUSES_HOT_TEMP_VAL_DEC_Msk (_U(0xF) << NVMCTRL_FUSES_HOT_TEMP_VAL_DEC_Pos)
...
#define NVMCTRL_FUSES_HOT_TEMP_VAL_INT_Msk (_U(0xFF) << NVMCTRL_FUSES_HOT_TEMP_VAL_INT_Pos)
...
#define NVMCTRL_FUSES_ROOM_ADC_VAL_Msk (_U(0xFFF) << NVMCTRL_FUSES_ROOM_ADC_VAL_Pos)
...
#define NVMCTRL_FUSES_ROOM_INT1V_VAL_Msk (_U(0xFF) << NVMCTRL_FUSES_ROOM_INT1V_VAL_Pos)
...
#define NVMCTRL_FUSES_ROOM_TEMP_VAL_DEC_Msk (_U(0xF) << NVMCTRL_FUSES_ROOM_TEMP_VAL_DEC_Pos)
...
#define NVMCTRL_FUSES_ROOM_TEMP_VAL_INT_Msk (_U(0xFF) << NVMCTRL_FUSES_ROOM_TEMP_VAL_INT_Pos)
