...
#define   GCLK_CLKCTRL_ID_DFLL48M_Val     _U(0x0)   /**< \brief (GCLK_CLKCTRL) DFLL48M Reference */
#define   GCLK_CLKCTRL_ID_WDT_Val         _U(0x1)   /**< \brief (GCLK_CLKCTRL) WDT */
#define   GCLK_CLKCTRL_ID_RTC_Val         _U(0x2)   /**< \brief (GCLK_CLKCTRL) RTC */
#define   GCLK_CLKCTRL_ID_EIC_Val         _U(0x3)   /**< \brief (GCLK_CLKCTRL) EIC */
#define   GCLK_CLKCTRL_ID_EVSYS_CHANNEL_0_Val _U(0x4)   /**< \brief (GCLK_CLKCTRL) EVSYS_CHANNEL_0 */
#define   GCLK_CLKCTRL_ID_EVSYS_CHANNEL_1_Val _U(0x5)   /**< \brief (GCLK_CLKCTRL) EVSYS_CHANNEL_1 */
#define   GCLK_CLKCTRL_ID_EVSYS_CHANNEL_2_Val _U(0x6)   /**< \brief (GCLK_CLKCTRL) EVSYS_CHANNEL_2 */
#define   GCLK_CLKCTRL_ID_EVSYS_CHANNEL_3_Val _U(0x7)   /**< \brief (GCLK_CLKCTRL) EVSYS_CHANNEL_3 */
#define   GCLK_CLKCTRL_ID_EVSYS_CHANNEL_4_Val _U(0x8)   /**< \brief (GCLK_CLKCTRL) EVSYS_CHANNEL_4 */
#define   GCLK_CLKCTRL_ID_EVSYS_CHANNEL_5_Val _U(0x9)   /**< \brief (GCLK_CLKCTRL) EVSYS_CHANNEL_5 */
#define   GCLK_CLKCTRL_ID_EVSYS_CHANNEL_6_Val _U(0xA)   /**< \brief (GCLK_CLKCTRL) EVSYS_CHANNEL_6 */
#define   GCLK_CLKCTRL_ID_EVSYS_CHANNEL_7_Val _U(0xB)   /**< \brief (GCLK_CLKCTRL) EVSYS_CHANNEL_7 */
#define   GCLK_CLKCTRL_ID_SERCOMX_SLOW_Val _U(0xC)   /**< \brief (GCLK_CLKCTRL) SERCOMx_SLOW */
#define   GCLK_CLKCTRL_ID_SERCOM0_CORE_Val _U(0xD)   /**< \brief (GCLK_CLKCTRL) SERCOM0_CORE */
#define   GCLK_CLKCTRL_ID_SERCOM1_CORE_Val _U(0xE)   /**< \brief (GCLK_CLKCTRL) SERCOM1_CORE */
#define   GCLK_CLKCTRL_ID_SERCOM2_CORE_Val _U(0xF)   /**< \brief (GCLK_CLKCTRL) SERCOM2_CORE */
#define   GCLK_CLKCTRL_ID_SERCOM3_CORE_Val _U(0x10)   /**< \brief (GCLK_CLKCTRL) SERCOM3_CORE */
#define   GCLK_CLKCTRL_ID_SERCOM4_CORE_Val _U(0x11)   /**< \brief (GCLK_CLKCTRL) SERCOM4_CORE */
#define   GCLK_CLKCTRL_ID_SERCOM5_CORE_Val _U(0x12)   /**< \brief (GCLK_CLKCTRL) SERCOM5_CORE */
#define   GCLK_CLKCTRL_ID_TC0_TC1_Val     _U(0x13)   /**< \brief (GCLK_CLKCTRL) TC0,TC1 */
#define   GCLK_CLKCTRL_ID_TC2_TC3_Val     _U(0x14)   /**< \brief (GCLK_CLKCTRL) TC2,TC3 */
#define   GCLK_CLKCTRL_ID_TC4_TC5_Val     _U(0x15)   /**< \brief (GCLK_CLKCTRL) TC4,TC5 */
#define   GCLK_CLKCTRL_ID_TC6_TC7_Val     _U(0x16)   /**< \brief (GCLK_CLKCTRL) TC6,TC7 */
#define   GCLK_CLKCTRL_ID_ADC_Val         _U(0x17)   /**< \brief (GCLK_CLKCTRL) ADC */
#define   GCLK_CLKCTRL_ID_AC_DIG_Val      _U(0x18)   /**< \brief (GCLK_CLKCTRL) AC_DIG */
#define   GCLK_CLKCTRL_ID_AC_ANA_Val      _U(0x19)   /**< \brief (GCLK_CLKCTRL) AC_ANA */
#define   GCLK_CLKCTRL_ID_DAC_Val         _U(0x1A)   /**< \brief (GCLK_CLKCTRL) DAC */
#define   GCLK_CLKCTRL_ID_PTC_Val         _U(0x1B)   /**< \brief (GCLK_CLKCTRL) PTC */
...
#define   GCLK_GENCTRL_ID_GCLK0_Val       _U(0x0)   /**< \brief (GCLK_GENCTRL) Generic clock generator 0 */
#define   GCLK_GENCTRL_ID_GCLK1_Val       _U(0x1)   /**< \brief (GCLK_GENCTRL) Generic clock generator 1 */
#define   GCLK_GENCTRL_ID_GCLK2_Val       _U(0x2)   /**< \brief (GCLK_GENCTRL) Generic clock generator 2 */
#define   GCLK_GENCTRL_ID_GCLK3_Val       _U(0x3)   /**< \brief (GCLK_GENCTRL) Generic clock generator 3 */
#define   GCLK_GENCTRL_ID_GCLK4_Val       _U(0x4)   /**< \brief (GCLK_GENCTRL) Generic clock generator 4 */
#define   GCLK_GENCTRL_ID_GCLK5_Val       _U(0x5)   /**< \brief (GCLK_GENCTRL) Generic clock generator 5 */
#define   GCLK_GENCTRL_ID_GCLK6_Val       _U(0x6)   /**< \brief (GCLK_GENCTRL) Generic clock generator 6 */
#define   GCLK_GENCTRL_ID_GCLK7_Val       _U(0x7)   /**< \brief (GCLK_GENCTRL) Generic clock generator 7 */
...
#define   GCLK_GENDIV_ID_GCLK0_Val        _U(0x0)   /**< \brief (GCLK_GENDIV) Generic clock generator 0 */
#define   GCLK_GENDIV_ID_GCLK1_Val        _U(0x1)   /**< \brief (GCLK_GENDIV) Generic clock generator 1 */
#define   GCLK_GENDIV_ID_GCLK2_Val        _U(0x2)   /**< \brief (GCLK_GENDIV) Generic clock generator 2 */
#define   GCLK_GENDIV_ID_GCLK3_Val        _U(0x3)   /**< \brief (GCLK_GENDIV) Generic clock generator 3 */
#define   GCLK_GENDIV_ID_GCLK4_Val        _U(0x4)   /**< \brief (GCLK_GENDIV) Generic clock generator 4 */
#define   GCLK_GENDIV_ID_GCLK5_Val        _U(0x5)   /**< \brief (GCLK_GENDIV) Generic clock generator 5 */
#define   GCLK_GENDIV_ID_GCLK6_Val        _U(0x6)   /**< \brief (GCLK_GENDIV) Generic clock generator 6 */
#define   GCLK_GENDIV_ID_GCLK7_Val        _U(0x7)   /**< \brief (GCLK_GENDIV) Generic clock generator 7 */
