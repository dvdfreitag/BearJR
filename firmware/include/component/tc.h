...
#define   TC_CTRLA_PRESCALER_DIV1_Val     _U(0x0)   /**< \brief (TC_CTRLA) GCLK_TC */
#define   TC_CTRLA_PRESCALER_DIV2_Val     _U(0x1)   /**< \brief (TC_CTRLA) GCLK_TC/2 */
#define   TC_CTRLA_PRESCALER_DIV4_Val     _U(0x2)   /**< \brief (TC_CTRLA) GCLK_TC/4 */
#define   TC_CTRLA_PRESCALER_DIV8_Val     _U(0x3)   /**< \brief (TC_CTRLA) GCLK_TC/8 */
#define   TC_CTRLA_PRESCALER_DIV16_Val    _U(0x4)   /**< \brief (TC_CTRLA) GCLK_TC/16 */
#define   TC_CTRLA_PRESCALER_DIV64_Val    _U(0x5)   /**< \brief (TC_CTRLA) GCLK_TC/64 */
#define   TC_CTRLA_PRESCALER_DIV256_Val   _U(0x6)   /**< \brief (TC_CTRLA) GCLK_TC/256 */
#define   TC_CTRLA_PRESCALER_DIV1024_Val  _U(0x7)   /**< \brief (TC_CTRLA) GCLK_TC/1024 */
...
#define   TC_CTRLA_PRESCSYNC_GCLK_Val     _U(0x0)   /**< \brief (TC_CTRLA) Reload or reset Counter on next GCLK */
#define   TC_CTRLA_PRESCSYNC_PRESC_Val    _U(0x1)   /**< \brief (TC_CTRLA) Reload or reset Counter on next prescaler clock */
#define   TC_CTRLA_PRESCSYNC_RESYNC_Val   _U(0x2)   /**< \brief (TC_CTRLA) Reload or reset Counter on next GCLK. Reset prescaler counter */
...
#define   TC_CTRLBCLR_CMD_RETRIGGER_Val   _U(0x1)   /**< \brief (TC_CTRLBCLR) Force start, restart or retrigger */
#define   TC_CTRLBCLR_CMD_STOP_Val        _U(0x2)   /**< \brief (TC_CTRLBCLR) Force stop */
...
#define   TC_CTRLBSET_CMD_RETRIGGER_Val   _U(0x1)   /**< \brief (TC_CTRLBSET) Force start, restart or retrigger */
#define   TC_CTRLBSET_CMD_STOP_Val        _U(0x2)   /**< \brief (TC_CTRLBSET) Force stop */
...
#define   TC_EVCTRL_EVACT_PPW_Val         _U(0x5)   /**< \brief (TC_EVCTRL) Period captured into CC0 Pulse Width in CC1 */
#define   TC_EVCTRL_EVACT_PWP_Val         _U(0x6)   /**< \brief (TC_EVCTRL) Period captured into CC1 Pulse Width on CC0 */
